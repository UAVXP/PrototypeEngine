...
typedef BSPData<uint8_t, MAX_MAP_VISIBILITY> visdata_data;
typedef BSPData<uint8_t, MAX_MAP_LIGHTING> lightdata_data;
typedef BSPData<uint8_t, MAX_MAP_MIPTEX> texdata_data;
